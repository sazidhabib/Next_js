export default function SEOContent({ platformName }) {
  ...
  const p2 = platformName
    ...
    : `Most online downloaders are filled with intrusive ads and malicious scripts. MediaDrop provides a clean, user-friendly experience focused on performance. We support Facebook Reels download, YouTube to MP4 conversion, Instagram Reels saving, and TikTok No-Watermark downloads all in one place.`;
    ...
    <section className="py-16 sm:py-20 bg-slate-50/50">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <div className="prose prose-slate max-w-none">
          ...
          <h3 className="text-xl font-semibold text-slate-900 mt-8">{h2}</h3>
          <p className="text-slate-600 leading-relaxed">
            {p2}
          </p>

          <h3 className="text-xl font-semibold text-slate-900 mt-8">Our Commitment to Quality</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <div id="faq" className="pt-8">
            ...
            <div className="space-y-4 mt-5">
              <FAQItem
                ...
                answer="Yes! MediaDrop is 100% free. No registration, no hidden fees. Simply paste the video link and download."
              />
              <FAQItem
              ...
              <FAQItem
                ...
                answer="No. MediaDrop works entirely in your web browser. No software or browser extension is required."
              />
              <FAQItem
          ...
          {/* API Section */}
          <div id="api" className="pt-12">
            <h3 className="text-xl font-semibold text-slate-900">Developer API Access</h3>
            <p className="text-slate-600 leading-relaxed mt-2">
              MediaDrop provides a direct POST API endpoint at <code className="rounded bg-slate-200 px-1.5 py-0.5 text-xs text-indigo-700">/api/download</code> to programmatically extract and resolve video links. Send a JSON body containing <code className="rounded bg-slate-200 px-1.5 py-0.5 text-xs">{`{ "url": "..." }`}</code> to receive direct download formats.
            </p>
          </div>
        </div>
      </div>
...
function FAQItem({ question, answer }) {
  return (
    <div className="rounded-2xl bg-white p-6 border border-slate-100 shadow-sm transition-all hover:border-slate-200 hover:shadow-md">
