...
function FacebookIcon({ className = "h-full w-full" }) {
  return (
...
function YouTubeIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function InstagramIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function TikTokIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function TwitterIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function LinkedInIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function PinterestIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function DouyinIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" />
    </svg>
...
function KuaishouIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H8v-2h3v2zm0-4H8v-2h3v2zm5 4h-3v-6h3v6z" />
    </svg>
  );
}

function DiscordIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function QuoraIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function QQIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
function ReelsIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
      <rect width="18" height="18" x="3" y="3" rx="4" />
      <path d="m9 9 6 3-6 3V9z" fill="currentColor" stroke="none" />
      <path strokeLinecap="round" d="M3 8.5h18M8 3.5l-2 5M13 3.5l-2 5M18 3.5l-2 5" />
    </svg>
  );
}

function ShortsIcon({ className = "h-full w-full" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M17.77 10.32l-1.2-.5a3.9 3.9 0 0 0-5.2-1.8l-1.2.6a4 4 0 0 0-2.2 4.1 3.9 3.9 0 0 0 1.9 3.1l1.2.5a3.9 3.9 0 0 0 5.2 1.8l1.2-.6a4 4 0 0 0 2.2-4.1 3.9 3.9 0 0 0-1.9-3.1zm-7.9 4.3v-5.2l4.8 2.6-4.8 2.6z" />
    </svg>
  );
}
