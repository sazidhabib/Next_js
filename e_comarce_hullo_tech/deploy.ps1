# ============================================================
# Deployment Script for hullotech.com (cPanel)
# Run this from your project root in PowerShell:
#   .\deploy.ps1
# ============================================================

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "  HulloTech - cPanel Deploy Builder" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
$backendDirs = @("controllers", "db", "middlewares", "models", "router", "utils", "public")
...
# Copy the src directory (Next.js app router pages - needed for SSR)
if (Test-Path "src") {
    Write-Host "  Copying src directory..." -ForegroundColor Gray
    Copy-Item -Recurse "src" "deploy_package\src" -Force
}
