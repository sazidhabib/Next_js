  ...
  return (
    <main className="min-h-screen bg-star-light-gray pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <ul className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <li className="flex items-center gap-2">
            ...
            <span className="text-gray-900 font-semibold">Cameras</span>
          </li>
        </ul>
      </div>
      ...
      <div className="bg-white border-b border-star-gray py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600">
            DSLR, Mirrorless, Action and Security Cameras with genuine warranty.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <SubCategoryHeader customCategory="/camera" />
