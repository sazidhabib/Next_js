            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        <Link href="/" className="text-gray-600 hover:text-primary font-medium">হোম</Link>
                        <Link href="/popular-frames" className="text-gray-600 hover:text-primary font-medium">জনপ্রিয় ফ্রেম</Link>
                        <Link href="/text-frames" className="text-gray-600 hover:text-primary font-medium">টেক্সট ফ্রেম</Link>
                        <Link href="/all-frames" className="text-gray-600 hover:text-primary font-medium">সকল ফ্রেম</Link>
                        <Link href="/add-frame" className="text-gray-600 hover:text-primary font-medium">যুক্ত করুন</Link>
                        <Link href="/contact" className="text-gray-600 hover:text-primary font-medium">যোগাযোগ</Link>
                        ...
                        <div className="flex items-center gap-4 ml-4">
                            {!user || user.role === 'admin' ? (
                                ...
                                <>
                                    ...
                                    <Link href="/add-frame" className="flex items-center gap-2 bg-primary hover:bg-blue-600 text-white px-4 py-2 rounded-full font-medium transition-colors shadow-md shadow-blue-100">
                                        <Plus size={18} />
                                        যুক্ত করুন
                                    </Link>
                                    <div className="flex items-center gap-2">
                                        <Link href="/dashboard" className="flex items-center gap-2 bg-green-50 text-green-700 px-3 py-2 rounded-full font-medium border border-green-200 hover:bg-green-100">
                                            <User size={18} />
                                            {user.username || 'User'}
                                        </Link>
                                        <button
