            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 md:p-10">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                                className="w-full pl-10 pr-4 py-3 text-gray-500 rounded-lg border border-gray-200 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                    ...
                    {/* Phone field - kept in UI but might not be sent to backend if not in schema. 
                        ...
                        If schema has phone, add it to body. The snippet shows phone in UI. */}
                    <div className="space-y-2">
