    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#121420]/60 border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2 mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Designer Login</h1>
          <p className="text-xs text-gray-400">ডিজাইনার ড্যাশবোর্ডে প্রবেশ করতে লগইন করুন</p>
        </div>
        ...
        <div className="text-center mt-6 text-xs text-gray-450 relative z-10">
          <span>নতুন ডিজাইনার? </span>
          <Link href="/designer/register" className="text-[#00e599] hover:underline font-semibold">
