...
export default function EditDesignerPage({ params }) {
  ...
  useEffect(() => {
    fetch(`/api/admin/designers/${id}`)
      .then((res) => {
        if (!res.ok) throw new Error("ডিজাইনার ডেটা লোড করতে ব্যর্থ হয়েছে।");
        return res.json();
      })
      .then((data) => {
        if (data.designer) {
  ...
  async function handleSubmit(e) {
    ...
    if (photoFile) {
      try {
        ...
        formData.append("slug", form.slug || "temp-designer");
    ...
    try {
      ...
      if (res.ok) {
        toast.success("ডিজাইনার সফলভাবে আপডেট করা হয়েছে।");
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">ডিজাইনার এডিট করুন</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="/uploads/images/designer-name.jpg"
