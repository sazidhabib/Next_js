...
function SidebarContent({ isOpen, onClose }) {
  ...
  const toolsNav = [
    { label: "Glyphs", href: "#glyphs", icon: IconType },
    { label: "Font Pairing", href: "#pairing", icon: IconType },
    { label: "Type Tester", href: "#type-tester", icon: IconEdit3 },
    { label: "OpenType", href: "#opentype", icon: IconZap },
  ];
  ...
  return (
    <aside className={`bg-[#0d0e14] flex flex-col justify-between transition-all duration-300 ease-in-out overflow-y-auto ${
      isOpen 
