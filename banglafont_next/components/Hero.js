...
export default function Hero() {
  ...
  return (
    <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#121422] via-[#0f111a] to-[#090a0f] border border-white/10 p-4 sm:p-6 md:p-10 overflow-hidden shadow-2xl">
      ...
      <div className="relative z-10 space-y-6 sm:space-y-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
          ...
          <div className="lg:col-span-8 space-y-4 sm:space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] sm:text-xs text-[#00e599] font-medium">
              <IconSparkles />
            ...
            <div className="relative max-w-xl">
              <div className="flex items-center justify-between gap-2 sm:gap-4 bg-[#131520]/80 border border-white/10 rounded-xl sm:rounded-2xl pl-3 sm:pl-4 pr-2 py-2 focus-within:border-[#00e599]/60 transition-all shadow-inner">
                <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                  <IconSearch className="text-gray-400 text-base sm:text-lg shrink-0" />
                  <input
                    type="text"
                    placeholder="Search fonts, foundry or styles..."
                    className="bg-transparent text-xs sm:text-sm text-white placeholder-gray-500 outline-none w-full min-w-0"
                  />
                </div>
                <Link
                  href="/free-fonts"
                  className="flex items-center gap-1.5 sm:gap-2.5 hover:text-[#00e599] transition-all text-[10px] sm:text-xs font-semibold text-gray-300 shrink-0"
                >
                  <span className="hidden sm:inline">Browse All Fonts</span>
                  <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#00e599] hover:bg-[#00c784] text-gray-950 flex items-center justify-center transition-all">
            ...
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 pt-2 overflow-x-auto">
              ...
              <button
                type="button"
                className="px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-lg sm:rounded-xl text-[10px] sm:text-xs font-medium border bg-transparent border-white/10 text-gray-400 hover:text-white hover:bg-white/5 transition-all flex items-center gap-1.5 cursor-pointer shrink-0"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 pt-6 sm:pt-8 border-t border-white/10">
          <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/5 border border-white/5">
            ...
            <div className="min-w-0">
              <div className="text-[10px] sm:text-xs font-bold text-white truncate">Premium Quality</div>
              <div className="text-[8px] sm:text-[10px] text-gray-400 truncate">Handcrafted by expert type designers</div>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/5 border border-white/5">
            ...
            <div className="min-w-0">
              <div className="text-[10px] sm:text-xs font-bold text-white truncate">OpenType Features</div>
              <div className="text-[8px] sm:text-[10px] text-gray-400 truncate">Ligatures, stylistic sets, and more</div>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/5 border border-white/5">
            ...
            <div className="min-w-0">
              <div className="text-[10px] sm:text-xs font-bold text-white truncate">Multi-Platform</div>
              <div className="text-[8px] sm:text-[10px] text-gray-400 truncate">Works on all devices and platforms</div>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/5 border border-white/5">
            ...
            <div className="min-w-0">
              <div className="text-[10px] sm:text-xs font-bold text-white truncate">Secure & Licensed</div>
              <div className="text-[8px] sm:text-[10px] text-gray-400 truncate">100% secure and licensed fonts</div>
            </div>
          </div>
        </div>
      </div>
