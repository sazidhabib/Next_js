...
export const experiences = [
  {
    ...
    skills: [
      "ReactJS", "Redux", "NodeJs", "ExpressJS", "Laravel", "MySQL", "Tailwind CSS", "JavaScript", "MongoDB", "Teamwork", "Leadership", "Communication"
    ],
  },
  {
    id: 1,
    ...
    skills: [
      "ReactJS", "Redux", "NodeJs", "Tailwind CSS", "TypeScript", "JavaScript", "MongoDB", "Teamwork", "Leadership", "Communication"
    ],
  },
  {
    id: 2,
    ...
    desc: [
      "Imaginary Work station is a software company that specializes in mixed-reality games, web development and mobile and desktop application.",
      "Started independently and after sometime joined a team of 5 more colleagues with key roles in company.",
      "Developed 2D and 3D games for Android.",
      "Created particle systems, shaders, textures, and animations to simulate various natural and magical phenomena."
    ],
    skills: [
      "Unity", "C#", "Game Development", "Visual effect graph", "Particle System", "Teamwork", "Leadership", "Communication"
    ],
  },
  {
    id: 3,
    img: "/planet/cse-club.png",
