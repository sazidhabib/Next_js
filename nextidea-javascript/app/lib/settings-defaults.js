export const DEFAULT_SETTINGS = [
  ...
  { key: 'service_social_media_marketing_features', value: JSON.stringify([{title: 'Strategy Development', description: 'Comprehensive social media strategy tailored to your business goals.', icon: 'Target'}, {title: 'Content Calendar', description: 'Planned out content for consistent posting and engagement.', icon: 'Calendar'}, {title: 'Media Buying & Ads', description: 'Running and optimizing paid campaigns for maximum ROI.', icon: 'TrendingUp'}, {title: 'Sales Funnel Monitoring', description: 'Continuous tracking and optimizing to drive more conversions.', icon: 'Filter'}, {title: 'Design & Video', description: 'Engaging visuals, animations, and video content strategies.', icon: 'Palette'}, {title: 'Community Management', description: 'Active engagement with your followers to build brand loyalty.', icon: 'Users'}]), type: 'json', description: 'Social Media Marketing Features' },
  ...
  { key: 'service_creative_concept_execution_process', value: JSON.stringify([{"title":"Creative Campaigns","description":"Our team designs captivating campaigns that engage your audience across digital and traditional platforms.","icon":"Trophy"},{"title":"Content Creation","description":"We craft compelling content, including visuals, copy, and multimedia, to convey your brand's story effectively.","icon":"FileText"},{"title":"Brand Messaging","description":"We refine your brand's messaging to deliver a clear, consistent, and impactful narrative.","icon":"Star"}]), type: 'json', description: 'Creative Concept - WHAT WE OFFER (Process Steps)' },
  { key: 'service_creative_concept_execution_related_services', value: JSON.stringify([{"title":"Brand Identity","link":"/services/brand-identity","icon":"Palette"},{"title":"Digital Media Buying","link":"/services/digital-media-buying","icon":"TrendingUp"},{"title":"Video Production","link":"/services/video-production-photography","icon":"Headphones"}]), type: 'json', description: 'Creative Concept Related Services' }
,
  { key: 'service_web_design_development_features', value: JSON.stringify([{"title":"User-Centric Design","description":"We prioritize user experience to ensure your visitors stay engaged and convert.","icon":"Layout"},{"title":"Mobile Optimization","description":"Your site will look and perform beautifully on every device, from mobile to desktop.","icon":"Smartphone"},{"title":"Scalable Architecture","description":"We build with the future in mind, ensuring your site can grow with your business.","icon":"Zap"}]), type: 'json', description: 'Web Design Features' },
  { key: 'service_web_design_development_related_services', value: JSON.stringify([{"title":"SEO Services","link":"/services/seo","icon":"Search"},{"title":"Brand Identity","link":"/services/brand-identity","icon":"Palette"},{"title":"Digital Media Buying","link":"/services/digital-media-buying","icon":"TrendingUp"}]), type: 'json', description: 'Web Design Related Services' },
  { key: 'service_brand_identity_related_services', value: JSON.stringify([{"title":"Creative Concept","link":"/services/creative-concept-execution","icon":"Sparkles"},{"title":"Web Design","link":"/services/web-design-development","icon":"Code2"},{"title":"Social Media","link":"/services/social-media-marketing","icon":"Megaphone"}]), type: 'json', description: 'Brand Identity Related Services' },
  { key: 'service_social_media_marketing_related_services', value: JSON.stringify([{"title":"Digital Media Buying","link":"/services/digital-media-buying","icon":"TrendingUp"},{"title":"Creative Concept","link":"/services/creative-concept-execution","icon":"Sparkles"},{"title":"Video Production","link":"/services/video-production-photography","icon":"Video"}]), type: 'json', description: 'Social Media Related Services' },
  { key: 'service_video_production_photography_process', value: JSON.stringify([{"title":"Pre-production","description":"Scripting, storyboarding, and planning to ensure a smooth shoot.","icon":"Clapperboard"},{"title":"Production","description":"High-quality filming and photography using professional equipment.","icon":"Camera"},{"title":"Post-production","description":"Editing, sound design, and color grading to bring the story to life.","icon":"Scissors"}]), type: 'json', description: 'Video Production Process' },
  { key: 'service_video_production_photography_related_services', value: JSON.stringify([{"title":"Social Media","link":"/services/social-media-marketing","icon":"Share2"},{"title":"Brand Identity","link":"/services/brand-identity","icon":"Palette"},{"title":"Creative Concept","link":"/services/creative-concept-execution","icon":"Sparkles"}]), type: 'json', description: 'Video Production Related Services' },
  { key: 'service_event_and_activation_related_services', value: JSON.stringify([{"title":"Social Media","link":"/services/social-media-marketing","icon":"Megaphone"},{"title":"Digital PR","link":"/services/digital-pr","icon":"Globe"},{"title":"Video Coverage","link":"/services/video-production-photography","icon":"Video"}]), type: 'json', description: 'Event Activation Related Services' },
  { key: 'service_seo_features_title', value: "What's Included", type: 'text', description: 'Seo - Features Section Title' },
  { key: 'service_seo_process_title', value: 'Our Process', type: 'text', description: 'Seo - Process Section Title' },
  { key: 'service_seo_related_title', value: 'Related Services', type: 'text', description: 'Seo - Related Services Title' },
  { key: 'service_web_design_development_features_title', value: 'OUR APPROACH', type: 'text', description: 'Web Design - OUR APPROACH Title' },
  { key: 'service_web_design_development_related_title', value: 'Related Services', type: 'text', description: 'Web Design Development - Related Services Title' },
  { key: 'service_brand_identity_features_title', value: "What's Included", type: 'text', description: 'Brand Identity - Features Section Title' },
  { key: 'service_brand_identity_related_title', value: 'Related Services', type: 'text', description: 'Brand Identity - Related Services Title' },
  { key: 'service_creative_concept_execution_features_title', value: 'WHAT SETS US APART', type: 'text', description: 'Creative Concept - WHAT SETS US APART Title' },
  { key: 'service_creative_concept_execution_process_title', value: 'WHAT WE OFFER', type: 'text', description: 'Creative Concept - WHAT WE OFFER Title' },
  { key: 'service_creative_concept_execution_related_title', value: 'Related Services', type: 'text', description: 'Creative Concept - Related Services Title' },
  { key: 'service_digital_media_buying_features_title', value: "What's Included", type: 'text', description: 'Digital Media Buying - Features Section Title' },
  { key: 'service_digital_media_buying_related_title', value: 'Related Services', type: 'text', description: 'Digital Media Buying - Related Services Title' },
  { key: 'service_design_printing_features_title', value: "What's Included", type: 'text', description: 'Design Printing - Features Section Title' },
  { key: 'service_design_printing_related_title', value: 'Related Services', type: 'text', description: 'Design Printing - Related Services Title' },
  { key: 'service_digital_pr_features_title', value: "What's Included", type: 'text', description: 'Digital Pr - Features Section Title' },
  { key: 'service_digital_pr_related_title', value: 'Related Services', type: 'text', description: 'Digital Pr - Related Services Title' },
  { key: 'service_event_and_activation_features_title', value: "What's Included", type: 'text', description: 'Event And Activation - Features Section Title' },
  { key: 'service_event_and_activation_process_title', value: 'Our Process', type: 'text', description: 'Event And Activation - Process Section Title' },
  { key: 'service_event_and_activation_related_title', value: 'Related Services', type: 'text', description: 'Event And Activation - Related Services Title' },
  { key: 'service_social_media_marketing_features_title', value: "What's Included", type: 'text', description: 'Social Media - What\'s Included Title' },
  { key: 'service_social_media_marketing_related_title', value: 'Related Services', type: 'text', description: 'Social Media - Related Services Title' },
  { key: 'service_video_production_photography_features_title', value: "What's Included", type: 'text', description: 'Video Production Photography - Features Section Title' },
  { key: 'service_video_production_photography_process_title', value: 'Our Process', type: 'text', description: 'Video Production Photography - Process Section Title' },
  { key: 'service_video_production_photography_related_title', value: 'Related Services', type: 'text', description: 'Video Production Photography - Related Services Title' },
  { key: 'global_work', value: JSON.stringify([{"id":1,"title":"Campaigns","image":"https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&q=80","color":"from-orange-500 to-amber-400","link":"/protfolio?category=Campaigns"},{"id":2,"title":"Audio Visuals","image":"https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=800&q=80","color":"from-purple-500 to-pink-400","link":"/protfolio?category=Audio%20Visuals"},{"id":3,"title":"Creatives","image":"https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&q=80","color":"from-blue-500 to-cyan-400","link":"/protfolio?category=Creatives"},{"id":4,"title":"Printing and Packaging","image":"/Printing-packagi.png","color":"from-green-500 to-emerald-400","link":"/protfolio?category=Printing%20%26%20Packaging"},{"id":5,"title":"Events and Activations","image":"https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80","color":"from-rose-500 to-red-400","link":"/protfolio?category=Events%20and%20Activations"},{"id":6,"title":"Website","image":"https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=800&q=80","color":"from-indigo-500 to-violet-400","link":"/protfolio?category=Website"}]), type: 'json', description: 'Global Work/Portfolio Categories' },
  { key: 'global_case_studies', value: JSON.stringify([{"id":1,"title":"Turning Conversations into Conversions: The Lead Generation Success Story of Western Consulting Firm","category":"Lead Generation","image":"/Case-study.jpg","link":"/case-study/western-consulting"},{"id":2,"title":"From Zero to High-Intent Traffic: How Mostofa Pipe Built SEO Visibility in Just 5 Months","category":"SEO","image":"/CaseStudy2.jpg","link":"/case-study/mostofa-pipe"},{"id":3,"title":"How Next Idea Solution Drove 300X ROAS for Urban's Premium Real Estate Project in Dhaka","category":"Real Estate","image":"/case-study3.jpg","link":"/case-study/urban-imperials"}]), type: 'json', description: 'Global Case Studies' },
  { key: 'home_work', value: JSON.stringify([{"id":1,"title":"Campaigns","image":"https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&q=80","color":"from-orange-500 to-amber-400","link":"/protfolio?category=Campaigns"},{"id":2,"title":"Audio Visuals","image":"https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=800&q=80","color":"from-purple-500 to-pink-400","link":"/protfolio?category=Audio%20Visuals"},{"id":3,"title":"Creatives","image":"https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&q=80","color":"from-blue-500 to-cyan-400","link":"/protfolio?category=Creatives"},{"id":4,"title":"Printing and Packaging","image":"/Printing-packagi.png","color":"from-green-500 to-emerald-400","link":"/protfolio?category=Printing%20%26%20Packaging"},{"id":5,"title":"Events and Activations","image":"https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80","color":"from-rose-500 to-red-400","link":"/protfolio?category=Events%20and%20Activations"},{"id":6,"title":"Website","image":"https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=800&q=80","color":"from-indigo-500 to-violet-400","link":"/protfolio?category=Website"}]), type: 'json', description: 'Home Page Work Section' },
  { key: 'home_case_studies', value: JSON.stringify([{"id":1,"title":"Turning Conversations into Conversions: The Lead Generation Success Story of Western Consulting Firm","category":"Lead Generation","image":"/Case-study.jpg","link":"/case-study/western-consulting"},{"id":2,"title":"From Zero to High-Intent Traffic: How Mostofa Pipe Built SEO Visibility in Just 5 Months","category":"SEO","image":"/CaseStudy2.jpg","link":"/case-study/mostofa-pipe"},{"id":3,"title":"How Next Idea Solution Drove 300X ROAS for Urban's Premium Real Estate Project in Dhaka","category":"Real Estate","image":"/case-study3.jpg","link":"/case-study/urban-imperials"}]), type: 'json', description: 'Home Page Case Studies' },
];