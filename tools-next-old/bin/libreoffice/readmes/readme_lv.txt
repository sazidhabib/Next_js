...
RPMS (vai attiecīgi DEBS) mape satur arī pakotni ar nosaukumu libreoffice-freedesktop24.2-menus-24.2.0.1-1.noarch.rpm (vai attiecīgi libreoffice24.2-debian-menus_24.2.0.1-1_all.deb). Šī ir pakotne visām Linux distribūcijām, kas atbalsta Freedesktop.org specifikācijas/rekomendācijas (https://en.wikipedia.org/wiki/Freedesktop.org), un tā tiek nodrošināta Linux distribūcijām, kas nav apskatītas iepriekš minētajās instrukcijās.
...
Mēs ceram, ka jums patiks strādāt ar jauno LibreOffice 24.2 un jūs mums pievienosieties tiešsaistē.
