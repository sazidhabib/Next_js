            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Manage all your real estate properties from here.{" "}
                        <span className="text-sm">({filteredProperties.length} total)</span>
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    <Button variant="outline" size="sm" onClick={fetchProperties} disabled={isLoading} className="gap-2">
            ...
            <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-4 border-b border-border flex items-center gap-4 bg-background/50">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            type="text"
                            placeholder="Search properties by title or category..."
                            value={searchQuery}
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-border">
                                {filteredProperties.map((property) => (
                                    <tr key={property.id} className="hover:bg-secondary/10 transition-colors group">
                                        ...
                                        <td className="px-6 py-3">
                                            ...
                                            <div className="text-xs text-muted-foreground mt-0.5">ID: {property.id}</div>
                                        </td>
                                        ...
                                        <td className="px-6 py-3">
                                            <span
                                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border capitalize ${getStatusStyle(property.status)}`}
                                            >
                                                {property.status}
                                            </span>
                                        </td>
