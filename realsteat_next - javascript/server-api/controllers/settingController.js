...
exports.updateSettings = async (req, res) => {
    ...
    try {
        ...
        const [result] = await pool.query(
            ...
            WHERE id = 1`,
            [
                site_title !== undefined ? site_title : current.site_name,
                support_email !== undefined ? support_email : current.support_email,
                helpline_number !== undefined ? helpline_number : current.helpline_number,
                footer_text !== undefined ? footer_text : current.footer_text,
                logo_url,
                favicon_url,
                site_description !== undefined ? site_description : current.site_description,
                ...
                address_text !== undefined ? address_text : current.address_text,
