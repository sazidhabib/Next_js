...
const locations = [
    ...
    { id: 2, city: "New York City", rentImage: "https://images.unsplash.com/photo-1449844908441-8829872d2607?auto=format&fit=crop&w=800&q=80", saleImage: "https://images.unsplash.com/photo-1470075801209-17f9ec0cada6?auto=format&fit=crop&w=800&q=80", rentLabel: "CABIN RETREATS", saleLabel: "URBAN APARTMENTS" },
    { id: 3, city: "Paris", rentImage: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80", saleImage: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80", rentLabel: "CABIN RETREATS", saleLabel: "URBAN APARTMENTS" },
    { id: 4, city: "Tokyo", rentImage: "https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&w=800&q=80", saleImage: "https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?auto=format&fit=crop&w=800&q=80", rentLabel: "CABIN RETREATS", saleLabel: "URBAN APARTMENTS" },
    { id: 5, city: "Munich", rentImage: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=800&q=80", saleImage: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80", rentLabel: "CABIN RETREATS", saleLabel: "URBAN APARTMENTS" },
    { id: 6, city: "New York City", rentImage: "https://images.unsplash.com/photo-1449844908441-8829872d2607?auto=format&fit=crop&w=800&q=80", saleImage: "https://images.unsplash.com/photo-1470075801209-17f9ec0cada6?auto=format&fit=crop&w=800&q=80", rentLabel: "CABIN RETREATS", saleLabel: "URBAN APARTMENTS" },
    { id: 7, city: "Paris", rentImage: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80", saleImage: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80", rentLabel: "CABIN RETREATS", saleLabel: "URBAN APARTMENTS" },
    { id: 8, city: "Tokyo", rentImage: "https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&w=800&q=80", saleImage: "https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?auto=format&fit=crop&w=800&q=80", rentLabel: "CABIN RETREATS", saleLabel: "URBAN APARTMENTS" },
];
...
export function LocationsSection() {
        ...
        const interval = setInterval(() => {
            if (scrollRef.current) {
                ...
                if (scrollLeft + clientWidth >= scrollWidth - 10) {
                    ...
                    const itemWidth = (scrollRef.current.firstElementChild)?.offsetWidth || 400;
    ...
    useEffect(() => {
        const updateFocus = () => {
            ...
            const slides = Array.from(container.querySelectorAll(".loc-slide"));
