...
(function () {
  ...
  function injectStyles() {
    ...
    style.innerHTML = [
      ...
      '  background: #ffffff;',
      '  border-radius: 16px;',
      '  box-shadow: 0 25px 60px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(0, 0, 0, 0.08);',
      '  display: flex;',
      ...
      '  .fow-overlay { padding: 0 !important; }',
      '  .fow-modal-container {',
      ...
      '  }',
      '  .fow-close-btn { top: 10px; right: 10px; }',
      '}',
  ...
  function openModal(slug) {
    ...
    if (!iframeEl.src || iframeEl.src !== embedUrl) {
      if (spinnerEl) {
      ...
      // If already loaded with the same restaurant, hide spinner immediately
      if (spinnerEl) {
