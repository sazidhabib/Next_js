...
const VideoNewsEdit = () => {
    ...
    const [currentImages, setCurrentImages] = useState({ thumbImage: '', metaImage: '' });
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                setCurrentImages({ thumbImage: n.thumbImage, metaImage: n.metaImage });
        ...
        <Container fluid className="py-4">
            <Form onSubmit={handleAction}>
                <div className="d-flex justify-content-between mb-3">
                    <h4>Edit Video News</h4>
                    <Button type="submit" disabled={loading}>{loading ? 'Saving...' : 'Update Video News'}</Button>
                </div>
                ...
                <Row>
                    <Col md={8}>
                        <Card className="mb-3"><Card.Body>
                            ...
                            <Form.Group className="mb-3"><Form.Label>Short Description</Form.Label><Form.Control as="textarea" rows={3} value={formData.shortDescription} onChange={e => setFormData({...formData, shortDescription: e.target.value})} placeholder="Brief summary of the video news (plain text)..." /></Form.Group>
                    ...
                    <Col md={4}>
                        <Card className="mb-3"><Card.Body>
                            ...
                            <Form.Group className="mb-3"><Form.Label>Thumbnail Image (Optional)</Form.Label>
