...
Åbn nu et af LibreOffice-programmerne, f.eks. Writer. Gå til menuen Funktioner og vælg Indstillinger. I dialogboksen Indstillinger, klik på "Sprog og lokalitetsindstillinger" og klik så på "Generelt". Klik på rullefelt-menuen "Brugerflade" og vælg det sprog, du netop installerede. Hvis du ønsker det, så gør det samme for "Valgt lokalitetsindstilling", "Standardvaluta" og "Standardsprog for dokumenter".
