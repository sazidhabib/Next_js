...
Die vouer RPMS (of DEBS) bevat ook 'n pakket libreoffice 24.2-freedesktop-menu's- 24.2.0.11.noarch.rpm  (of libreoffice$ {PRODUCTVERSION}-debian-menu's _ $ {PRODUCTVERSION} .0.1 -1_all.deb of soortgelyk). Hierdie pakket is geskik vir alle Linux-distribusies wat voldoen aan die Freedesktop.org-spesifikasies / -aanbevelings   (  https://de.wikipedia.org /wiki/Freedesktop.org ), en moet in staat wees om gebruik te word vir alle Linux-stelsels wat nie hier beskryf word nie.
...
Ons hoop u geniet dit om met die nuwe LibreOffice 24.2 te werk en dat u aanlyn by ons sal aansluit.
