...
======================================================================
Plik ReadMe programu LibreOffice 24.2
======================================================================
...
Katalog RPM (lub odpowiednio DEB) zawiera również pakiet o nazwie libreoffice24.2-freedesktop-menus-24.2.0.1-1.noarch.rpm (lub libreoffice24.2-debian-menus_24.2.0.1-1_all.deb). Jest on przeznaczony dla wszystkich dystrybucji Linuksa które wspierają specyfikacje/rekomendacje Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org) i nie zostały ujęte w niniejszej instrukcji.
...
Mamy nadzieję, że jesteś zadowolonym użytkownikiem nowego LibreOffice 24.2 i przyłączysz się do nas w internecie.
