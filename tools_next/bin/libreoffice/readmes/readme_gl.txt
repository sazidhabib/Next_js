...
======================================================================
Ficheiro Léame do LibreOffice 24.2
======================================================================
...
O directorio de RPM (ou DEB, segundo corresponda) tamén contén un paquete chamado libreoffice24.2-freedesktop-menus-24.2.0.1-1.noarch.rpm (ou libreoffice24.2-debian-menus_24.2.0.1-1_all.deb, respectivamente, ou semellante). Consiste nun paquete para todas as distribucións que admiten as especificacións de Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org), e fornécese para permitir a instalación noutras distribucións de Linux non cubertas nas instrucións mencionadas.
...
Esperamos que aprecie traballar co novoLibreOffice 24.2 e que se una a nós na rede.
