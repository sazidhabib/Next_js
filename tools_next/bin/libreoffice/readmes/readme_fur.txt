...
======================================================================
File leimi di LibreOffice 24.2
======================================================================
...
La cartele RPMS (o DEBS, secont il câs) e conten ancje un pachet clamât libreoffice24.2-freedesktop-menus-24.2.0.1-1.noarch.rpm (o libreoffice24.2-debian-menus_24.2.0.1-1_all.deb, secont il câs, o similâr). Chest al è un pachet par dutis lis distribuzions Linux che a supuartin lis specifichis/racomandazions di Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org), e al ven furnît pes instalazions su altris distribuzions di Linux no tratadis intes istruzions menzonadis in precedence.
...
O sperin che tu gjoldedis a lavorâ cul gnûf LibreOffice 24.2 e che tu partecipedis ae nestre comunitât online.
