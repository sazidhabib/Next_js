...
Start nu een van de LibreOffice-applicaties, bijvoorbeeld Writer. Ga naar het menu Extra en kies Opties. Klik in het dialoogvenster Opties op "Taalinstellingen" en klik vervolgens op "Talen". Vervolg de lijst "Gebruikersinterface" en selecteer de taal die u zojuist hebt geïnstalleerd. Als u wilt, doet u hetzelfde voor de "Landinstelling", de "Standaard munteenheid" en de "Standaardtalen voor documenten".
...
We hopen dat het werken met de nieuwe LibreOffice 24.2 u bevalt en u zich online bij ons aansluit.
